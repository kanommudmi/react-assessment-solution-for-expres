      ...
      <section className="w-full flex justify-center">
        <div className="w-full max-w-3xl bg-white border rounded-2xl p-5">
          ...
          {authLoading ? (
            ...
            <div className="text-sm mt-2 font-bold">Please log in to use the AI feature</div>
          )}
        ...
        {view === "user" ? (
          ...
          <section className=" p-5  flex">
            {authLoading ? (
              ...
              <AdminTable users={users} setUsers={setUsers} fetchUsers={fetchUsers} API={apiBase} />
            ) : (
